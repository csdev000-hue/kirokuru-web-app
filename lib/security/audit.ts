...
const auditSchema = z.object({
  ...
  metadata: z.object({
    ...
    changedFields: z.array(z.enum(["meetingDate", "displayName", "speakerUserId", "speakerName", "startedAt", "endedAt", "text", "sequenceNo", "joinedAt", "leftAt", "type", "priority", "name", "description", "status", "role", "assigneeId", "dueDate", "title"])).max(20).optional(),
