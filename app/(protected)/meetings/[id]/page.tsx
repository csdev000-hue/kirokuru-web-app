...
export default async function Page({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<Record<string, string | string[] | undefined>> }) {
 ...
 <section aria-label="関連情報"><Link href={`/meetings/${id}/minutes`}>AI議事録を確認</Link>{meeting.recording && <p>録音データあり（{meeting.recording.status}）</p>}{meeting.minutes && <p>議事録データあり（version {meeting.minutes.version}）</p>}</section></main>;
}
